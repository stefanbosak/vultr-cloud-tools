...
# container as builder for preparing Vultr cloud tools
FROM vultr-cloud-tools-builder AS vultr-cloud-tools-sofka-builder

LABEL stage="vultr-cloud-tools-sofka-builder" \
      description="Debian-based container builder for preparing Vultr cloud tool sofka CLI" \
      org.opencontainers.image.description="Debian-based container builder for preparing Vultr cloud tool sofka CLI" \
      org.opencontainers.image.url=https://github.com/stefanbosak/vultr-cloud-tools \
      org.opencontainers.image.source=https://github.com/stefanbosak/vultr-cloud-tools
...
COPY --from=vultr-cloud-tools-ansible-cli-builder "/usr/local/share/uv/tools" "/usr/local/share/uv/tools"
